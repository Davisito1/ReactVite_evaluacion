...
const ProductForm = ({ initialData = {}, onSubmit, submitting = false, onClose, categories = [] }) => {
  ...
  const handleChange = (e) => {
    const { tittle, value } = e.target
    setForm((prev) => ({ ...prev, [tittle]: value }))
  }
          ...
          <div className="sm:col-span-2">
            <div className="mt-2 flex items-center justify-end gap-3">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="rounded-2xl bg-green-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-indigo-500 disabled:cursor-not-allowed disabled:bg-slate-400"
              >
